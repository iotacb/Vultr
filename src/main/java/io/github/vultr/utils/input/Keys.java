package io.github.vultr.utils.input;
...
public class Keys {
    ...
    public static int GP_A = 0;
    public static int GP_X = 2;
    public static int GP_Y = 3;
    public static int GP_B = 1;
    public static int GP_RB = 5;
    public static int GP_LB = 4;
    public static int GP_RTB = 8;
    public static int GP_LTB = 9;
    public static int GP_UP = 10;
    public static int GP_LEFT = 13;
    public static int GP_RIGHT = 11;
    public static int GP_DOWN = 12;
    public static int GP_OPTIONS = 7;
    public static int GP_MENU = 6;
